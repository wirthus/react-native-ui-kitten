 ...
 * import { ApplicationProvider, IconRegistry, Layout, Text, Icon, Button } from '@wirthus/ui-kitten-components';
 * import { EvaIconsPack } from '@wirthus/ui-kitten-eva-icons'; // <-- Make sure it is installed.
 *
